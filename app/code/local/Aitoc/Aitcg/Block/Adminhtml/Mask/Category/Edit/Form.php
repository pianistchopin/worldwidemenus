...
class Aitoc_Aitcg_Block_Adminhtml_Mask_Category_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('name_suffix', 'text', array(
            'label'     => Mage::helper('aitcg')->__('Size'),
            'class'     => 'required-entry',
            'required'  => true,
            'name'      => 'name_suffix',
        ));
