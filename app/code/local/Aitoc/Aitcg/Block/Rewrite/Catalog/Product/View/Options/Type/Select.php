...
class Aitoc_Aitcg_Block_Rewrite_Catalog_Product_View_Options_Type_Select extends Mage_Catalog_Block_Product_View_Options_Type_Select
{
	/**
	...
	public function getValuesHtml()
	{
		...
		if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
			...
			foreach ($_option->getValues() as $_value) {
				...
				if($_option->getOptionForSection() == "shape_mask") {
					$params['mask'] = $_value->getMaskCategory();
				}
                if($_option->getOptionForSection() == "cover_image") {
                    $params['data-catid'] = $_value->getCoverCategory();
                }
				$select->addOption(
