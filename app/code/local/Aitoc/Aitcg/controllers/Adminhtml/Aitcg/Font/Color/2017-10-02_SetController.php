...
class Aitoc_Aitcg_Adminhtml_Aitcg_Font_Color_SetController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('catalog/aitcg/font_color');
    }
