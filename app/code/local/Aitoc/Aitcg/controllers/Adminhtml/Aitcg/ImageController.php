...
class Aitoc_Aitcg_Adminhtml_Aitcg_ImageController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        if ( $this->getRequest()->getPost() ) {
            try {
                ...
                if(isset($_FILES['embossfilename']['name']) and (file_exists($_FILES['embossfilename']['tmp_name'])))
                {
                    $embosspath = $imageModel->getEmbossImagesPath();
                    $postData['embossfilename'] = Aitoc_Aitcg_Model_Image::uploadEmbossFile($embosspath, 'embossfilename', array('jpg','jpeg','png'));
                }
                ...
                if(isset($postData['embossfilename'])) {
                    $imageModel->setEmbossFilenameWithUnlink($postData['embossfilename']);
                }
                $imageModel->save();
