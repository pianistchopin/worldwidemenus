...
class FME_Photogallery_Block_Adminhtml_Photogallery extends Mage_Adminhtml_Block_Widget_Grid_Container
{
  public function __construct()
  {
    ...
    $this->_addButtonLabel = Mage::helper('photogallery')->__('Add Photogallery');
    parent::__construct();
  }
}
