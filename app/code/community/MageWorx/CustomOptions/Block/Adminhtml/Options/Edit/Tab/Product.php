...
class MageWorx_CustomOptions_Block_Adminhtml_Options_Edit_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid {

    public function __construct() {
        parent::__construct();
        $this->setTemplate('mageworx/customoptions/widget-grid.phtml');
...
//            ->group('e.entity_id');
        ...
        if (method_exists($collection, 'addCategoryIds')) $collection->addCategoryIds();
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('category', array(
            ...
            'renderer' => 'mageworx_customoptions/adminhtml_options_edit_tab_renderer_prodcat',
    ...
    protected function _prepareMassaction() {
        ...
        $massBlock->setTemplate('mageworx/customoptions/widget-grid-massaction.phtml');
    ...
    public function category_filter($collection, $column) {
        ...
        if (empty($cond['eq'])) return true;
        $category = Mage::getModel('catalog/category')->load($cond['eq']);
        if ($category && $category->getId()) $collection->addCategoryFilter($category);
    }
