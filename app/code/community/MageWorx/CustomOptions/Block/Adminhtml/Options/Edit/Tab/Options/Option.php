...
class MageWorx_CustomOptions_Block_Adminhtml_Options_Edit_Tab_Options_Option extends MageWorx_CustomOptions_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Option {
    ...
    public function getOptionValues() {                        
        ...
        $groupStore = Mage::getSingleton('mageworx_customoptions/group_store')->loadByGroupAndStore($groupId, $this->getStoreId());
