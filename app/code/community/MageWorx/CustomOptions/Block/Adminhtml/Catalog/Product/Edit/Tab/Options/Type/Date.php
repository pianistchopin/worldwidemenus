 ...
 */
class MageWorx_CustomOptions_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Type_Date extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Type_Date {

    public function __construct() {
        parent::__construct();
        if (!Mage::helper('mageworx_customoptions')->isEnabled()) return $this;
        $this->setTemplate('mageworx/customoptions/catalog-product-edit-options-type-date.phtml');
    }
    ...
    protected function _prepareLayout() {
        ...
        $this->setChild('add_image_button',
                        ...
                        ->setData(array(
                            ...
                            'onclick' => ' productOptionTypeDate.createFileField(this.id)',
                            'disabled' => true
                        )));
