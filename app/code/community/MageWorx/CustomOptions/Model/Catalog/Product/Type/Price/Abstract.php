...
} else if ((string)Mage::getConfig()->getModuleConfig('DerModPro_BCP')->active == 'true'){
    class MageWorx_CustomOptions_Model_Catalog_Product_Type_Price_Abstract extends DerModPro_BCP_Model_Catalog_Product_Type_Price //DerModPro_BCP_Model_Catalog_Product_Type_Configurable_Price 
    {}    
} else if ((string)Mage::getConfig()->getModuleConfig('Bluejalappeno_Tieredproducts')->active == 'true'){
    class MageWorx_CustomOptions_Model_Catalog_Product_Type_Price_Abstract extends Bluejalappeno_Tieredproducts_Model_Product_Type_Price {}
} else {
