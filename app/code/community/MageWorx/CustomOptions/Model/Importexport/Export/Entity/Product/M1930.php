...
class MageWorx_CustomOptions_Model_Importexport_Export_Entity_Product_M1930 extends Mage_ImportExport_Model_Export_Entity_Product
{
    ...
    public function exportFile() {
        ...
        while (true) {
            ...
            foreach ($this->_storeIdToCode as $storeId => &$storeCode) {
                $options = Mage::getResourceModel('mageworx_customoptions/product_option_collection')
                    ->reset()
                ...
                foreach ($options as $option) {
                    ...
                    if ($defaultStoreId == $storeId) {
                        ...
                        $row['_custom_option_show_swatch_title']     = $option['show_swatch_title'];
                    ...
                    if ($values) {
                        ...
                        foreach ($values as $value) {
                            ...
                            if ($defaultStoreId == $storeId) {
                                ...
                                $row['_custom_option_row_extra']  = $value['extra'];
