...
/**
 * Class Ophirah_Qquoteadv_Block_Adminhtml_System_Config_Form_Massupdateranges
 */
class Ophirah_Qquoteadv_Block_Adminhtml_System_Config_Form_Massupdateranges extends Ophirah_Qquoteadv_Block_Adminhtml_System_Config_Formfield
{
    /**
