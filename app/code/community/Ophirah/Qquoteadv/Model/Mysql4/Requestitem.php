...
/**
 * Class Ophirah_Qquoteadv_Model_Mysql4_Requestitem
 */
class Ophirah_Qquoteadv_Model_Mysql4_Requestitem extends Mage_Core_Model_Mysql4_Abstract
{
     ...
     * @return $this
     */
    public function removeByQuoteadvProductId($productId){
        if(is_int($productId)){
            $this->_getWriteAdapter()->delete(
                $this->getMainTable(),
                $this->_getWriteAdapter()->quoteInto('quoteadv_product_id=?', $productId)
            );
        }
        return $this;
    }
