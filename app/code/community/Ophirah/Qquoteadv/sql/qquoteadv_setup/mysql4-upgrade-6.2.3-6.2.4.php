 ...
 * Tables settings
 */
$table_qqadvpcustomer = 'quoteadv_customer';
$newColumns = array(
    "shipping_customer_address_id" => "Shipping customer address id",
    "customer_address_id" => "billing customer address id"
);
 ...
 */
$tableName = $installer->getTable($table_qqadvpcustomer);
