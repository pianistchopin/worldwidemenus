    ...
    extends Mage_Catalog_Block_Product_View_Options_Type_Select
{
    ...
    {
        if (Mage::getStoreConfig('qquoteadv_general/orderability_and_prices/enabled') == 0 ||
            Mage::getStoreConfig('qquoteadv_general/orderability_and_prices/usetemplates') == 0) {
            ...
            if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
                ...
                foreach ($_option->getValues() as $_value) {
                    ...
                    if (!Mage::helper('not2order')->getShowPrice($this->getProduct())) {
                        $priceStr = '';
                    }
